    ...
    echo '
        <footer>
            ...
            <div id="Legal-and-Policies">
                ...
                <div id="legal-text">
                    <a href="./LegalAndPolicies.php" id="legal-text1">Privacy Policy</a>
                    <a href="./LegalAndPolicies.php" id="legal-text2">Terms of Use</a>
                    <a href="./LegalAndPolicies.php" id="legal-text3">Cookies</a>
                </div>
            </div>
        </footer>
    ';
